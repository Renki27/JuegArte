...
public class AbstractDialog implements DialogInterface {
    ...
    public static final int BUTTON_NEUTRAL = 11;
    ...
    protected DialogButton mNeutralButton;
    ...
    protected AbstractDialog(@NonNull Activity mActivity,
                             ...
                             @NonNull DialogButton mNeutralButton,
    ...
    protected View createView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container) {
        ...
        MaterialButton mNeutralButtonView = dialogView.findViewById(R.id.button_neutral);
        ...
        if (mNeutralButton != null) {
            ...
            mNeutralButtonView.setText(mNeutralButton.getTitle());
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP && mNeutralButton.getIcon() != NO_ICON) {
                mNeutralButtonView.setIcon(mActivity.getDrawable(mNeutralButton.getIcon()));
            }

            mNeutralButtonView.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    mNeutralButton.getOnClickListener().onClick(AbstractDialog.this, BUTTON_NEUTRAL);
                }
            });
        } else {
            mNeutralButtonView.setVisibility(View.INVISIBLE);
        }
        ...
        try {
            ...
            // Set Positive Button Icon Tint
            ColorStateList mNeutralButtonTint = a.getColorStateList(
                    R.styleable.MaterialDialog_material_dialog_neutral_button_text_color);

            if (mNeutralButtonTint == null) {
                mNeutralButtonTint = ContextCompat.getColorStateList(
                        mActivity.getApplicationContext(),
                        R.color.material_dialog_neutral_button_text_color);
            }
            mNeutralButtonView.setTextColor(mNeutralButtonTint);
            mNeutralButtonView.setIconTint(mNeutralButtonTint);
