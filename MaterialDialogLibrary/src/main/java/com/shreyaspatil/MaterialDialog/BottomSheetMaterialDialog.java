...
public class BottomSheetMaterialDialog extends AbstractDialog {
    ...
    protected BottomSheetMaterialDialog(@NonNull final Activity mActivity,
        ...
        super(mActivity, title, message, mCancelable, mPositiveButton, mNegativeButton, mNeutralButton, mAnimationResId, mAnimationFile);
    ...
    public static class Builder {
         ...
         */
        @NonNull
        public Builder setNeutralButton(@NonNull String name, @NonNull OnClickListener onClickListener) {
         ...
         */
        @NonNull
        public Builder setNeutralButton(@NonNull String name, int icon, @NonNull OnClickListener onClickListener) {
            neutralButton = new DialogButton(name, icon, onClickListener);
            return this;
        }
        ...
        public BottomSheetMaterialDialog build() {
            return new BottomSheetMaterialDialog(activity, title, message, isCancelable, positiveButton, negativeButton, neutralButton, animationResId, animationFile);
        }
    }
